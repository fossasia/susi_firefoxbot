...
resetaccountcancel.addEventListener("click", function (event) {
	event.preventDefault();
	document.getElementById("forgot-form").style.display = "none";
});

forgotaccount.addEventListener("click", function (event) {
	event.preventDefault();
...
resetaccount.addEventListener("click", function (event) {
	event.preventDefault();
